...
*/
const { getAllPricesByNameProduct, getUnvalitedPricesByNameProduct, getAllPriceByHuile, getAllPriceByHuileAndFilter, getAllPrice } = require('../controllers/API.controller.prix')
...
//On sauvegarde les prix collectés par les enqueteurs : *success
/*
  @route /addPrices
  @method POST 
...
//le producteur peut modifier les prix de ses produits via cette route : *success
/*
